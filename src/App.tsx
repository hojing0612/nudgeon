      ...
      <div className="workspace">
        <aside className="rail" aria-label="현재 단계 창문">
          ...
          <svg className="window" viewBox="0 0 120 104" aria-hidden="true">
            <rect x="4" y="4" width="112" height="96" rx="8" fill="#806B54" />
            ...
            <rect x="12" y="12" width="96" height="80" rx="4" fill="none" stroke="#806B54" strokeWidth="1" />
            <rect x="58.5" y="12" width="3" height="80" fill="#806B54" />
            <rect x="12" y="49" width="96" height="3" fill="#806B54" />
            <g className="curtain l"><rect x="12" y="12" width="46" height="80" fill="#EDE8DE" opacity=".95" /></g>
            <g className="curtain r"><rect x="62" y="12" width="46" height="80" fill="#EDE8DE" opacity=".95" /></g>
            <rect x="4" y="4" width="112" height="96" rx="8" fill="none" stroke="#806B54" strokeWidth="7" />
          </svg>
